		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="invoice_bus_front.php"><i class="fa fa-file-pdf-o fa-fw"></i> Front-page</a></li>
					<li class="active"><a href="#"><i class="fa fa-file-pdf-o fa-fw "></i> Back-page</a></li>
                 
                <p><b>If you wish to add new Table for Another Month<b></p>
                <form method="POST">  
              <label>Enter table name:</label>
              <input type="text" name="tablename" id="tablename" placeholder="January_2023" />
              <input type="submit" name="create_table" placeholder="Create New table"  />
                </form>
...
<form action="" method="POST">
		...
		<br>
		<input class="print_button" type="submit" name="submit_choice" value="Display Data">
		
		<button class="print_button" >Refresh page</button>
</form>
...
if (isset($_POST["submit_data"]))  {
   ...
   $table_name = $_SESSION['tena'];
    ...
    if(mysqli_query($conn, $sql)) {
       ...
       window.onload = function () { alert("Invoice data inserted successfully!."); } 
        </script>'; 
 ...
 else if(isset($_POST["create_table"]))
 {
	  require('db/Invoice.php');
			...
			$sql = "CREATE TABLE $table_name (
				...
				big_bus VARCHAR(30) NOT NULL,
				min_bus VARCHAR(30) NOT NULL,
