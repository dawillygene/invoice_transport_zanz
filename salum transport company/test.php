...
<body>
	...
	<table  id="inventory" class="inventory">
			...
			<tbody>
				...
				<tr>
					<td><span contenteditable=""><input type="text" name="date1" class="ontable" size="30"></span></td>
					<td><span contenteditable=""><input type="text" name="big_bus1" class="ontable" size="30"></span></td>
					<td><span contenteditable=""><input type="text" name="min_bus1" class="ontable" size="30"></span></td>
					<td><span contenteditable=""><input type="submit" name="submit_data" class="save"></span></td>
				</tr>
...
if (isset($_POST["submit_data"]))  {
   ...
   //$table_name = $_SESSION['table_choice'];
    $date1 = $_POST['date1'];
    $big_bus1 = $_POST['big_bus1'];
    $min_bus1 = $_POST['min_bus1'];
    $sql = "INSERT INTO february (date,big_bus,min_bus) VALUES ('$date1', '$big_bus1','$min_bus1')";
    echo $sql;
    if(mysqli_query($conn, $sql)) {
     ...
     $_SESSION['table_choice'] = $table_name;
     // Create connection
