...
//error_reporting(E_ALL);    //codes to check errors to my code
...
<form action="" method="POST">
		<label for="table_name">Select Invoice:</label>
		...
		<br>
		<input style="width:14%;" type="submit" class="print_button" name="submit_choice" value="display Data">
</form>
...
<form action="front-print.php"><button style="float:left;" class="save">Print</button> </form>
<form action="new_invoice.php"><button style="float:right; width:19%;" class="save">Create New Invoice</button> </form>
