...
<body>
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			<a class="navbar-brand" href="#">STCI Admin v1.0</a> <!-- salum transport company invoices -->
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li class="active"><a href="#"><i class="fa fa-file-pdf-o fa-fw"></i> Front-page</a></li>
					<li ><a href="invoice_bus_back.php"><i class="fa fa-file-pdf-o fa-fw "></i> Back-page</a></li>
...
<div style="color:red;"><h1>Use This Template to Create a New Invoice</h1></div>
...
echo '<div><h1  style="color:red; font-size: 0.875em;">Please Enter the Data correctly.The process will be irrevesible after saving</h1></div>';
echo '	<header>';
echo '		<h1>Invoice</h1>';
...
echo '<div style="color:red;"></div>';
echo '<div style="color:red;font-size: 0.875em;">Recipient Address:click the address to edit</div>';
...
<form action="invoice_bus_front.php"><button style="float:right; width:12%;" class="save">Go Back</button> </form>
